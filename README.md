...
[![Flattr this git repo](http://api.flattr.com/button/flattr-badge-large.png)](https://flattr.com/submit/auto?user_id=ajvb&url=https://github.com/missmp/kala&title=Kala&language=&tags=github&category=software)
...
1. Change directory to Kala source
	...
	```
	cd $GOPATH/src/github.com/missmp/kala
	```
...
There are more examples in the [examples directory](https://github.com/missmp/kala/tree/master/examples) within this repo. Currently its pretty messy. Feel free to submit a new example if you have one.
...
#### Official:
* Go - [client](https://github.com/missmp/kala/tree/master/client) - Docs: http://godoc.org/github.com/missmp/kala/client

Install using:
`go get github.com/missmp/kala/client`

## Job Data Struct

[Docs can be found here](http://godoc.org/github.com/missmp/kala/job#Job)
...
```
{
        ...
        "command":"bash /home/ajvb/gocode/src/github.com/missmp/kala/examples/example-kala-commands/example-command.sh",
        "owner":"",
        "disabled":false,
        "dependent_jobs":null,
        "parent_jobs":null,
...
{"jobs":{}}
$ curl http://127.0.0.1:8000/api/v1/job/ -d '{"epsilon": "PT5S", "command": "bash /home/ajvb/gocode/src/github.com/missmp/kala/examples/example-kala-commands/example-command.sh", "name": "test_job", "schedule": "R2/2017-06-04T19:25:16.828696-07:00/PT10S"}'
{"id":"93b65499-b211-49ce-57e0-19e735cc5abd"}
$ curl http://127.0.0.1:8000/api/v1/job/
{
    "jobs":{
...
[Contributor Documentation can be found here](http://godoc.org/github.com/missmp/kala)
...
Check out this [example for how to add dependent jobs](https://github.com/missmp/kala/blob/master/examples/python/example_dependent_jobs.py) within a python script.
